import { createRouter, createWebHistory } from "./chunk-EAZ6DL52.js";
import { nextTick, onMounted, provide, reactive, ref, unref, watch } from "./chunk-7GDRTMHZ.js";
import "./chunk-WUGQLSLX.js";
import { Axios } from "./chunk-MH5SJMZH.js";
import "./chunk-PR4QN5HX.js";

// ../node_modules/.pnpm/gold-core@0.1.17/node_modules/gold-core/dist/index.js
var lt = Object.defineProperty;
var ut = (e5, r, t) =>
  r in e5 ? lt(e5, r, { enumerable: true, configurable: true, writable: true, value: t }) : (e5[r] = t);
var U = (e5, r, t) => (ut(e5, typeof r != "symbol" ? r + "" : r, t), t);
var O = ((e5) => (
  (e5.Number = "[object Number]"),
  (e5.Boolean = "[object Boolean]"),
  (e5.Object = "[object Object]"),
  (e5.Array = "[object Array]"),
  (e5.Function = "[object Function]"),
  (e5.String = "[object String]"),
  (e5.RegExp = "[object RegExp]"),
  (e5.Blob = "[object Blob]"),
  (e5.File = "[object File]"),
  (e5.Date = "[object Date]"),
  (e5.Error = "[object Error]"),
  (e5.Promise = "[object Promise]"),
  (e5.Undefined = "[object Undefined]"),
  (e5.Null = "[object Null]"),
  (e5.AsyncFunction = "[object AsyncFunction]"),
  e5
))(O || {});
...
var gt = ((e5) => (
  (e5[(e5.ms = 0)] = "ms"),
  (e5[(e5.hour = 1)] = "hour"),
  (e5[(e5.minute = 2)] = "minute"),
  (e5[(e5.second = 3)] = "second"),
  e5
))(gt || {});
var mt = ((e5) => (
  (e5.white = "37m"), (e5.red = "31m"), (e5.green = "32m"), (e5.yellow = "33m"), (e5.blue = "34m"), e5
))(mt || {});
...
function Ft(e5, r) {
  if (S(e5)) throw new Error(r);
}
function Mt(e5, r) {
  if (!H(e5)) throw new Error(r);
}
function jt(e5, r) {
  if (I(e5)) throw new Error(r);
}
function Ct(e5, r) {
  if (!nr(e5)) throw new Error(r);
}
function kt(e5, r) {
  if (I(e5)) throw new Error(r);
}
function xe(e5, r) {
  if (m(e5) === false) throw new Error(r);
}
function Lt(e5, r) {
  if (I(e5)) throw new Error(r);
}
...
function me(e5, r) {
  return e5.startsWith("http://") || e5.startsWith("https://")
    ? new URL(He(e5))
    : new URL(He(`${r || location.origin}/${e5}`));
}
function Dr(e5) {
    ...
    I(e5) ||
      e5.sort((n, a) => {
        let o = r(n),
          i = r(a);
        return (
          H(o) === false && (o = JSON.stringify(o)),
          H(i) === false && (i = JSON.stringify(i)),
          o === i ? 0 : t === Ur.DESC ? (i > o ? 1 : -1) : o > i ? 1 : -1
        );
      }),
    e5
  );
...
function ia(e5, r) {
  if ((xe(e5, "target is not Object"), r.includes(".") === false)) return Reflect.get(e5, r);
  const t = r.split(".");
  let n = { ...e5 };
  for (const a of t) {
    if (S(a) || m(n) === false || Reflect.has(n, a) === false) return "";
    n = Reflect.get(n, a);
  }
  return n;
}
function ca(e5) {
  if ((e5 instanceof Array && e5.splice(0, e5.length), m(e5)))
    for (const r of Object.keys(e5)) Reflect.deleteProperty(e5, r);
  return e5;
}
function sa() {
  const e5 = [],
    r = "0123456789abcdef";
  for (let t = 0; t < 36; t++) e5.push(r.substring(Math.floor(Math.random() * 16), 1));
  return (
    (e5[14] = "4"), (e5[19] = r.substring((e5[19] & 3) | 8, 1)), (e5[8] = e5[13] = e5[18] = e5[23] = "-"), e5.join("")
  );
}
function la(e5, r) {
...
function ua(e5, r) {
  return (
    S(r) && (r = ze.vertical), r === ze.vertical ? e5.scrollHeight > e5.clientHeight : e5.scrollWidth > e5.clientWidth
  );
}
function fa() {
...
function ya(e5, r) {
  if (r === Ve.FlatMap) {
    if (m(e5)) return ar(e5);
    if (e5 instanceof Array) return ir(e5);
  }
  if (r === Ve.URlParams) return new URLSearchParams(e5).toString();
}
function ar(e5, r) {
...
function pa(e5) {
  const r = new URLSearchParams(e5),
    t = {};
  return (
    r.forEach((n, a) => {
      Reflect.set(t, a, n);
...
function Bt(e5, r, t) {
  if (m(e5) === false || m(r) === false) throw new N("target and source 必须都为 Object");
  if (H(t == null ? void 0 : t.uniqueKey)) {
    const n = Reflect.get(e5, t == null ? void 0 : t.uniqueKey),
      a = Reflect.get(r, t == null ? void 0 : t.uniqueKey);
...
function Re(e5, r, t) {
  ...
  if (m(r) === false) throw new N("source 必须都为 Object");
  if (m(e5) === false) {
    if (t.strict === true) throw new N("严格模式：target 必须都为 Object");
  ...
  for (const o in r) {
    if (t != null && t.ignoreKey && t.ignoreKey.includes(o)) continue;
    const i = Reflect.get(e5, o),
      c = Reflect.get(r, o),
      s = E(i),
      l = E(c);
...
function Ge(e5, r, t) {
  if (I(t == null ? void 0 : t.uniqueKey)) throw new N("参数：option.uniqueKey can't be blank。");
  for (const n of r) {
    if (m(n)) {
      const a = e5.find((o) => Bt(o, n, t));
      if ((t == null ? void 0 : t.strict) === true && I(a)) continue;
      if (m(a)) {
        Re(a, n, t);
        continue;
      }
...
function Je(e5, r, t) {
  if (e5 instanceof Array && r instanceof Array) return Ge(e5, r, t);
  if (m(e5) && m(r)) return Re(e5, r, t);
...
function va(e5, r) {
  ...
  const t = { ...e5 };
  if (r.exclude !== void 0) for (const n of r.exclude) Reflect.deleteProperty(t, n);
  return t;
}
function Tt(e5) {
  if (S(e5) === false) {
    const r = e5.$el || e5;
    if (r instanceof HTMLElement) return r.getBoundingClientRect();
  }
  return new DOMRect();
}
function ga(e5) {
  const r = new RegExp("(^| )" + e5 + "=([^;]*)(;|$)"),
...
function ma(e5) {
  var r;
  if (S(e5)) return "";
  if (e5 instanceof Error) return e5.message;
  if (m(e5)) {
    if (Reflect.has(e5, "body")) return (r = e5.body) == null ? void 0 : r.message;
    if (Reflect.has(e5, "message")) return e5.message;
  }
  return e5;
}
function ba(e5) {
...
function Ne(e5, r, t) {
  ...
  if (S(n)) return t == null ? void 0 : t.defaultValue;
  try {
...
function vr(e5, r, t, n) {
  if ((g.debug(`storage.set：key = ${r}`), I(t))) return;
  const a = JSON.stringify(t),
    o = (n == null ? void 0 : n.encrypt) === true ? Ke + qr(a) : a;
  e5.setItem(r, o);
}
function Dt(e5) {
  e5.clear();
...
var Aa = class {
  constructor(r, t = 12, n) {
    ...
    (this.__dataSource = r),
      (this.__max = t + 1),
      (this.__denominator = t),
      (this.__pointList = [{ row: 1, column: 1 }]),
      (this.__height = n);
  }
  get pointList() {
  ...
  includePoint({ row: r, column: t }) {
    for (const n of this.data) if (this.include(n.row, r) && this.include(n.column, t)) return true;
    return false;
  }
  mergeArea() {
    for (const r of this.pointList) this.includePoint(r) && Object.assign(r, { disabled: true });
  }
  orderArea() {
  ...
  removeMarkArea() {
    ...
    for (let t = r - 1; t >= 0; t--) this.pointList[t].disabled === true && this.pointList.splice(t, 1);
  }
  crossVerify(r, { start: t, end: n }) {
    return !(t + 1e-3 > r.end || n - 1e-3 < r.start);
  }
  crossArea({ row: r, column: t }) {
    for (const n of this.data) if (this.crossVerify(n.row, r) && this.crossVerify(n.column, t)) return true;
    return false;
  }
  /**
   * 点位向上移动， 每次减 1
  ...
  parseArea(r) {
    ...
    if (t > this.__max - 1 || n > this.__max - 1) throw new Error("数据异常，请检查。");
    const o = { ...a };
    let i = false;
...
function zt(e5) {
  ...
  return (
    ...
    Object.keys(e5).forEach(function (n) {
...
var Vt = function () {
  ...
  if (o.length !== 1 || o[0] !== t || !Object.prototype.propertyIsEnumerable.call(r, t)) return false;
  if (typeof Object.getOwnPropertyDescriptor == "function") {
    var i = Object.getOwnPropertyDescriptor(r, t);
    if (i.value !== a || i.enumerable !== true) return false;
  }
  return true;
};
...
var Xt = function (r) {
  var t = this;
  if (typeof t != "function" || Kt.call(t) !== Qt) throw new TypeError(Jt + t);
  for (
    var n = Fe.call(arguments, 1),
      a,
      o = function () {
        if (this instanceof a) {
          var u = t.apply(this, n.concat(Fe.call(arguments)));
          return Object(u) === u ? u : this;
        } else return t.apply(r, n.concat(Fe.call(arguments)));
      },
    ...
    c.push("$" + s);
  if (
    ((a = Function("binder", "return function (" + c.join(",") + "){ return binder.apply(this,arguments); }")(o)),
    t.prototype)
  ) {
    var l = function () {};
...
var on = function e(r) {
  var t;
  if (r === "%AsyncFunction%") t = Me("async function () {}");
  else if (r === "%GeneratorFunction%") t = Me("function* () {}");
  else if (r === "%AsyncGeneratorFunction%") t = Me("async function* () {}");
...
var fn = function (r) {
  var t = _e(r, 0, 1),
    n = _e(r, -1);
  if (t === "%" && n !== "%") throw new ie("invalid intrinsic syntax, expected closing `%`");
  if (n === "%" && t !== "%") throw new ie("invalid intrinsic syntax, expected opening `%`");
  var a = [];
  return (
    br(r, ln, function (o, i, c, s) {
...
var sr = function (r, t) {
  if (typeof r != "string" || r.length === 0) throw new ae("intrinsic name must be a non-empty string");
  if (arguments.length > 1 && typeof t != "boolean") throw new ae('"allowMissing" argument must be a boolean');
  if (sn(/^%?[^%]*%?$/, r) === null)
  ...
  for (var u = 1, y = true; u < n.length; u += 1) {
    ...
    if (((f === "constructor" || !y) && (s = true), (a += "." + f), (i = "%" + a + "%"), Pe(Z, i))) c = Z[i];
    else if (c != null) {
      if (!(f in c)) {
        if (!t) throw new ae("base intrinsic for " + r + " exists, but the property is not available.");
        return;
      }
      if (Y && u + 1 >= n.length) {
        var b = Y(c, f);
...
(function (e5) {
  var r = cr,
    ...
    o = t("%Reflect.apply%", true) || r.call(a, n),
    i = t("%Object.getOwnPropertyDescriptor%", true),
    c = t("%Object.defineProperty%", true),
    s = t("%Math.max%");
  if (c)
    try {
      c({}, "a", { value: 1 });
  ...
  e5.exports = function (y) {
    ...
    if (i && c) {
      var v = i(f, "length");
      v.configurable && c(f, "length", { value: 1 + s(0, y.length - (arguments.length - 1)) });
    }
    return f;
  };
  var l = function () {
...
var $ =
  typeof Symbol == "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === ce || "symbol")
    ? Symbol.toStringTag
    : null;
...
var _r =
  ...
  ([].__proto__ === Array.prototype
    ...
    : null);
function Er(e5, r) {
  if (e5 === 1 / 0 || e5 === -1 / 0 || e5 !== e5 || (e5 && e5 > -1e3 && e5 < 1e3) || Kr.call(/e/, r)) return r;
  var t = /[0-9](?=(?:[0-9]{3})+(?![0-9]))/g;
  if (typeof e5 == "number") {
    var n = e5 < 0 ? -Pr(-e5) : Pr(e5);
    if (n !== e5) {
      var a = String(n),
        o = fr.call(r, a.length + 1);
...
var $n = function e2(r, t, n, a) {
  ...
  if (typeof r == "string") return et(r, o);
  if (typeof r == "number") {
  ...
  if ((typeof n > "u" && (n = 0), n >= u && u > 0 && typeof r == "object")) return Ze(r) ? "[Array]" : "[Object]";
  var y = Hn(o, n);
  if (typeof a > "u") a = [];
  else if (Zr(a, r) >= 0) return "[Circular]";
  function f(F, W, L) {
  ...
  if (Nn(r)) {
    var ee = Se(r, f);
    return !("cause" in Error.prototype) && "cause" in r && !Qr.call(r, "cause")
      ? "{ [" + String(r) + "] " + C.call(Rr.call("[cause]: " + f(r.cause), ee), ", ") + " }"
      : ee.length === 0
      ? "[" + String(r) + "]"
      : "{ [" + String(r) + "] " + C.call(ee, ", ") + " }";
  }
  if (typeof r == "object" && i) {
    if (xr && typeof r[xr] == "function" && Ye) return Ye(r, { depth: u - n });
  ...
  if (Dn(r)) {
    ...
    return (
      wr &&
        wr.call(r, function (F) {
          fe.push(f(F, r));
        }),
      Nr("Set", $e.call(r), fe, y)
    );
  }
  if (Bn(r)) return Ue("WeakMap");
  if (Wn(r)) return Ue("WeakSet");
  if (Tn(r)) return Ue("WeakRef");
  if (Mn(r)) return de(f(Number(r)));
  if (Cn(r)) return de(f(Qe.call(r)));
  if (jn(r)) return de(An.call(r));
  if (Fn(r)) return de(f(String(r)));
  if (!In(r) && !Ir(r)) {
    var J = Se(r, f),
      ye = _r ? _r(r) === Object.prototype : r instanceof Object || r.constructor === Object,
      D = r instanceof Object ? "" : "null prototype",
      re = !ye && $ && Object(r) === r && $ in r ? fr.call(G(r), 8, -1) : D ? "Object" : "",
      K = ye || typeof r.constructor != "function" ? "" : r.constructor.name ? r.constructor.name + " " : "",
      te = K + (re || D ? "[" + C.call(Rr.call([], re || [], D || []), ": ") + "] " : "");
...
function Yr(e5) {
  if (ce) return e5 && typeof e5 == "object" && e5 instanceof Symbol;
  if (typeof e5 == "symbol") return true;
  if (!e5 || typeof e5 != "object" || !Xe) return false;
  try {
...
function Cn(e5) {
  if (!e5 || typeof e5 != "object" || !Qe) return false;
  try {
...
function Zr(e5, r) {
  if (e5.indexOf) return e5.indexOf(r);
  for (var t = 0, n = e5.length; t < n; t++) if (e5[t] === r) return t;
  return -1;
}
function Un(e5) {
  if (!Ee || !e5 || typeof e5 != "object") return false;
  try {
    Ee.call(e5);
    try {
      $e.call(e5);
...
function Bn(e5) {
  if (!he || !e5 || typeof e5 != "object") return false;
  try {
    he.call(e5, he);
    try {
      ve.call(e5, ve);
...
function Tn(e5) {
  if (!Ar || !e5 || typeof e5 != "object") return false;
  try {
...
function Dn(e5) {
  if (!$e || !e5 || typeof e5 != "object") return false;
  try {
    $e.call(e5);
    try {
      Ee.call(e5);
...
function Wn(e5) {
  if (!ve || !e5 || typeof e5 != "object") return false;
  try {
    ve.call(e5, ve);
    try {
      he.call(e5, he);
...
function qn(e5) {
  return !e5 || typeof e5 != "object"
    ? false
    : typeof HTMLElement < "u" && e5 instanceof HTMLElement
    ? true
    : typeof e5.nodeName == "string" && typeof e5.getAttribute == "function";
}
function et(e5, r) {
  if (e5.length > r.maxStringLength) {
    var t = e5.length - r.maxStringLength,
...
function Hn(e5, r) {
  var t;
  if (e5.indent === "	") t = "	";
  else if (typeof e5.indent == "number" && e5.indent > 0) t = C.call(Array(e5.indent + 1), " ");
  else return null;
  return {
    base: t,
...
function Se(e5, r) {
  ...
  if (t) {
    n.length = e5.length;
    for (var a = 0; a < e5.length; a++) n[a] = z(e5, a) ? r(e5[a], e5) : "";
  }
  var o = typeof Le == "function" ? Le(e5) : [],
    i;
  if (ce) {
    i = {};
    for (var c = 0; c < o.length; c++) i["$" + o[c]] = o[c];
  }
  for (var s in e5)
    z(e5, s) &&
      ((t && String(Number(s)) === s && s < e5.length) ||
        (ce && i["$" + s] instanceof Symbol) ||
        (Kr.call(/[^\w$]/, s) ? n.push(r(s, e5) + ": " + r(e5[s], e5)) : n.push(s + ": " + r(e5[s], e5))));
  if (typeof Le == "function")
    for (var l = 0; l < o.length; l++) Qr.call(e5, o[l]) && n.push("[" + r(o[l]) + "]: " + r(e5[o[l]], e5));
  return n;
}
var yr = sr;
var le = hn;
...
var pr = function (e5, r) {
  for (var t = e5, n; (n = t.next) !== null; t = n)
    if (n.key === r) return (t.next = n.next), (n.next = e5.next), (e5.next = n), n;
};
...
var oo = function () {
  var r,
    ...
    a = {
      assert: function (o) {
        if (!a.has(o)) throw new Jn("Side channel does not contain " + Gn(o));
      },
      get: function (o) {
      ...
      has: function (o) {
        if (we && o && (typeof o == "object" || typeof o == "function")) {
          ...
          if (t) return eo(t, o);
        } else if (n) return no(n, o);
        return false;
      },
      set: function (o, i) {
        we && o && (typeof o == "object" || typeof o == "function")
          ? (r || (r = new we()), Qn(r, o, i))
          : Ae
          ? (t || (t = new Ae()), Zn(t, o, i))
          : (n || (n = { key: {}, next: null }), to(n, o, i));
      },
    };
  return a;
};
...
var Q = Array.isArray;
var M = (function () {
  for (var e5 = [], r = 0; r < 256; ++r) e5.push("%" + ((r < 16 ? "0" : "") + r.toString(16)).toUpperCase());
  return e5;
})();
var so = function (r) {
  for (; r.length > 1; ) {
...
var yo = function (r, t, n, a, o) {
  ...
  var i = r;
  if (
    (typeof r == "symbol" ? (i = Symbol.prototype.toString.call(r)) : typeof r != "string" && (i = String(r)),
    n === "iso-8859-1")
  )
  ...
  for (var c = "", s = 0; s < i.length; ++s) {
    ...
    (s += 1),
      (l = 65536 + (((l & 1023) << 10) | (i.charCodeAt(s) & 1023))),
      (c += M[240 | (l >> 18)] + M[128 | ((l >> 12) & 63)] + M[128 | ((l >> 6) & 63)] + M[128 | (l & 63)]);
  }
  return c;
};
var po = function (r) {
...
var Ro = function e4(r, t, n, a, o, i, c, s, l, u, y, f, v, p, b, w) {
  for (var h = r, P = w, x = 0, ee = false; (P = P.get(De)) !== void 0 && !ee; ) {
    var ue = P.get(r);
    if (((x += 1), typeof ue < "u")) {
      if (ue === x) throw new RangeError("Cyclic object value");
      ee = true;
    }
  ...
  if (
    (typeof s == "function"
      ...
      : n === "comma" &&
        B(h) &&
        (h = rr.maybeMap(h, function (Ie) {
          return Ie instanceof Date ? y(Ie) : Ie;
        })),
    h === null)
  ) {
    if (o) return c && !p ? c(t, _.encoder, b, "key", f) : t;
    h = "";
  }
  ...
  var re = [];
  if (typeof h > "u") return re;
  var K;
  if (n === "comma" && B(h)) K = [{ value: h.length > 0 ? h.join(",") || null : void 0 }];
  else if (B(s)) K = s;
  else {
  ...
  for (var F = a && B(h) && h.length === 1 ? t + "[]" : t, W = 0; W < K.length; ++W) {
    var L = K[W],
      pe = typeof L == "object" && typeof L.value < "u" ? L.value : h[L];
    if (!(i && pe === null)) {
      var st = B(h) ? (typeof n == "function" ? n(F, L) : F) : F + (u ? "." + L : "[" + L + "]");
      w.set(r, x);
      var hr = nt();
      hr.set(De, w), ot(re, e4(pe, st, n, a, o, i, c, s, l, u, y, f, v, p, b, hr));
    }
  }
  return re;
};
var Po = function (r) {
  ...
  if (typeof r.format < "u") {
    if (!bo.call(ge.formatters, r.format)) throw new TypeError("Unknown format option provided.");
    n = r.format;
  }
  var a = ge.formatters[n],
    o = _.filter;
  return (
    (typeof r.filter == "function" || B(r.filter)) && (o = r.filter),
    {
...
var _o = function (e5, r) {
  ...
  var v = i.join(n.delimiter),
    p = n.addQueryPrefix === true ? "?" : "";
  return (
    n.charsetSentinel && (n.charset === "iso-8859-1" ? (p += "utf8=%26%2310003%3B&") : (p += "utf8=%E2%9C%93&")),
    v.length > 0 ? p + v : ""
  );
};
var se = tt;
...
var No = function (r, t) {
  ...
  if (t.charsetSentinel)
    for (s = 0; s < i.length; ++s)
      i[s].indexOf("utf8=") === 0 &&
        (i[s] === Io ? (l = "utf-8") : i[s] === xo && (l = "iso-8859-1"), (c = s), (s = i.length));
  for (s = 0; s < i.length; ++s)
    if (s !== c) {
      var u = i[s],
        y = u.indexOf("]="),
        ...
        p;
      f === -1
        ? ((v = t.decoder(u, A.decoder, l, "key")), (p = t.strictNullHandling ? null : ""))
        : ((v = t.decoder(u.slice(0, f), A.decoder, l, "key")),
          (p = se.maybeMap(at(u.slice(f + 1), t), function (b) {
            return t.decoder(b, A.decoder, l, "value");
          }))),
        p && t.interpretNumericEntities && l === "iso-8859-1" && (p = $o(p)),
        u.indexOf("[]=") > -1 && (p = Eo(p) ? [p] : p),
        tr.call(n, v) ? (n[v] = se.combine(n[v], p)) : (n[v] = p);
    }
  return n;
};
var Fo = function (e5, r, t, n) {
  for (var a = n ? r : at(r, t), o = e5.length - 1; o >= 0; --o) {
    ...
    if (c === "[]" && t.parseArrays) i = [].concat(a);
      ...
      !t.parseArrays && s === ""
        ? (i = { 0: a })
        : !isNaN(l) && c !== s && String(l) === s && l >= 0 && t.parseArrays && l <= t.arrayLimit
        ? ((i = []), (i[l] = a))
        : s !== "__proto__" && (i[s] = a);
    }
    a = i;
...
var Mo = function (r, t, n, a) {
  if (r) {
    var o = n.allowDots ? r.replace(/\.([^.[]+)/g, "[$1]") : r,
      ...
      u = [];
    if (l) {
      if (!n.plainObjects && tr.call(Object.prototype, l) && !n.allowPrototypes) return;
      u.push(l);
    }
    for (var y = 0; n.depth > 0 && (s = c.exec(o)) !== null && y < n.depth; ) {
      if (((y += 1), !n.plainObjects && tr.call(Object.prototype, s[1].slice(1, -1)) && !n.allowPrototypes)) return;
      u.push(s[1]);
    }
...
var jo = function (r) {
  ...
  return {
    ...
    interpretNumericEntities:
      typeof r.interpretNumericEntities == "boolean" ? r.interpretNumericEntities : A.interpretNumericEntities,
...
var Co = function (e5, r) {
  var t = jo(r);
  if (e5 === "" || e5 === null || typeof e5 > "u") return t.plainObjects ? /* @__PURE__ */ Object.create(null) : {};
  for (
    var n = typeof e5 == "string" ? No(e5, t) : e5,
...
var To = qt(Bo);
var it = ((e5) => (
  (e5.Encoding = "accept-encoding"),
  (e5.Language = "accept-language"),
  (e5.ContentType = "content-type"),
  (e5.RequestedWith = "X-Requested-With"),
  (e5.Authorization = "authorization"),
  (e5.TokenAccess = "access_token"),
  (e5.TokenRefresh = "refresh_token"),
  e5
))(it || {});
...
var We = {
  ...
  hookVerify(e5, r) {
    ...
    this.enable() &&
      H(t) &&
      ((t.startsWith("TOKEN_") || t.startsWith("CREDENTIAL_")) &&
        (k.remove(
          "authorization"
          /* Authorization */
        ),
        this.hookLoginFailure(e5, r)),
      t === "LOGINED_AUTHORITY" && this.hookUnauthorized(e5, r),
      t.startsWith("ERROR_") && this.hookErrorUnknown(e5, r));
  },
  ...
  hookLoginFailure(e5, r) {
    throw (
      (g.warn(`请实现回调函数：Security.${this.hookLoginFailure.name}`, e5, r),
      new N("回话失效, 请重新登录...", X.info))
    );
  },
  hookUnauthorized(e5, r) {
    throw (
      (g.warn(`请实现回调函数：Security.${this.hookUnauthorized.name}`, e5, r),
      new N("无权访问，请检查权限...", X.info))
    );
  },
...
var jr = {
  resolve(e5) {
    ...
    return (
      I(e5.headers) === false && Je(r, e5.headers, { deep: true }),
      Reflect.set(e5, "headers", r),
      Reflect.get(
        r,
        "content-type"
        /* ContentType */
      ) === "application/json" && Reflect.set(e5, "data", JSON.stringify(e5.data)),
      g.debug("-----interceptor-Request------ config-after ->", e5),
      e5
    );
  },
  reject: ct,
...
var Cr = {
  resolve(e5) {
    const r = e5.headers;
    try {
      if ((We.hookResponseHeader(r), Reflect.has(r, "ignore-parse"))) return e5.data;
      if (H(e5.data) === false) return We.hookResponseDataParseFailure(e5.data, r);
      const t = JSON.parse(e5.data);
      return t.success === true
        ? t.data
        : (t.success === false && We.hookVerify(t, r), Promise.reject({ body: t, headers: r }));
    } catch (t) {
      return t instanceof N
        ? Reflect.get(console, t.type).call(console, t)
        : t instanceof Error
...
var Vo = class extends Axios {
  constructor(r, t) {
    super(t ? Je(zo, r || {}, { deep: true }) : r),
      t &&
        (g.debug("使用默认配置，并默认配置优先级较高..."),
        this.setInterceptorToRequeset(jr.resolve, jr.reject),
        this.setInterceptorToResponse(Cr.resolve, Cr.reject));
  }
  setConfig(r) {
...
var T = {
  ...
  beforeEach(e5, r) {
    return (
      g.warn(`请实现回调函数：SecurityRouter.${T.beforeEach.name}`, me(e5.fullPath).searchParams.get("token"), r), true
    );
  },
  beforeResolve(e5) {
...
function $a(e5) {
  ...
  return (
    r.beforeEach((t, n) => {
      if ((g.debug("gold-core：RouterVue —— beforeEach"), T.enable())) return T.beforeEach(t, n);
    }),
    r.beforeResolve((t) => {
      if ((g.debug("gold-core：RouterVue —— beforeResolve"), T.enable())) return T.beforeResolve(t);
    }),
    r.afterEach((t, n, a) => {
      if ((g.debug("gold-core：RouterVue —— afterEach"), T.enable())) return T.afterEach(t, n, a);
    }),
    Ho(r, e5.modules),
    r
  );
...
function xa() {
  const e5 = defineProps({
    ...
    r = ref(e5.modelValue),
    t = defineEmits(["update:modelValue"]);
  return (
    watch(
      () => e5.modelValue,
      (n) => (r.value = n)
...
function Go(e5, r) {
  const t = me(e5);
  g.debug(`gold-core：composable.Frame —— tabPaneAdd：${t.href}`),
    globalThis.top.postMessage(Object.assign(r || {}, { action: "tab-pane-add", href: t.href }), "*");
}
function ka(e5) {
...
function La(e5) {
  ...
  globalThis.window.addEventListener("message", ({ data: o }) => {
    if ((o == null ? void 0 : o.action) === "tab-pane-add") return n(o, e5);
    if ((o == null ? void 0 : o.action) === "tab-pane-close") return a(o);
  });
  function n(o, i) {
    var h;
    const { href: c, label: s, code: l, refresh: u, target: y, closable: f, mode: v } = o || {},
      p = me(o == null ? void 0 : o.href);
    if (y === "_blank") return globalThis.top.open(c), true;
    const b = I(l) ? p.origin + p.pathname + p.hash : l,
      w = (h = unref(r)) == null ? void 0 : h.find(({ code: P }) => b === P);
    if (i != null && i.sso && p.origin !== globalThis.top.location.origin) {
      const P = p.searchParams,
        x = "token";
    ...
    if (w === void 0 || I(w)) {
      ...
      u === true && p.searchParams.set("v", /* @__PURE__ */ new Date().getTime() + ""),
        Reflect.set(w, "href", p.href),
        Reflect.set(w, "label", s),
        Reflect.set(w, "refresh", u),
        Reflect.set(w, "closable", f),
        Reflect.set(w, "code", l),
        Reflect.set(w, "mode", v);
  ...
  return (
    provide("list-route", r),
    provide("tab-activate", t),
    e5.cacheable === true &&
      (watch(
        () => t.value,
        (o) => {
