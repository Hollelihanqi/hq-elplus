...
// ../node_modules/.pnpm/immutable@4.3.5/node_modules/immutable/dist/immutable.es.js
var DELETE = "delete";
var SHIFT = 5;
var SIZE = 1 << SHIFT;
var MASK = SIZE - 1;
...
function wholeSlice(begin, end, size) {
  return (
    ((begin === 0 && !isNeg(begin)) || (size !== void 0 && begin <= -size)) &&
...
function getIteratorFn(iterable) {
  var iteratorFn =
    iterable && ((REAL_ITERATOR_SYMBOL && iterable[REAL_ITERATOR_SYMBOL]) || iterable[FAUX_ITERATOR_SYMBOL]);
...
function interposeFactory(collection, separator) {
  ...
  interposedSequence.__iterateUncached = function (fn, reverse3) {
    ...
    collection.__iterate(function (v) {
      return (
        (!iterations || fn(separator, iterations++, this$1$1) !== false) && fn(v, iterations++, this$1$1) !== false
      );
    }, reverse3);
    return iterations;
  };
...
function deepMergerWith(merger) {
  function deepMerger(oldValue, newValue, key) {
    return isDataStructure(oldValue) && isDataStructure(newValue) && areMergeable(oldValue, newValue)
...
mixin(IndexedCollection, {
  ...
  get: function get8(index, notSetValue) {
    index = wrapIndex(this, index);
    return index < 0 || this.size === Infinity || (this.size !== void 0 && index > this.size)
      ? notSetValue
      : this.find(
          function (_, key) {
            return key === index;
  ...
  has: function has3(index) {
    index = wrapIndex(this, index);
    return (
      index >= 0 && (this.size !== void 0 ? this.size === Infinity || index < this.size : this.indexOf(index) !== -1)
    );
  },
...
var Repeat = (function (IndexedSeq2) {
  ...
  Repeat2.prototype.slice = function slice3(begin, end) {
    ...
    return wholeSlice(begin, end, size)
      ? this
      : new Repeat2(this._value, resolveEnd(end, size) - resolveBegin(begin, size));
  };
