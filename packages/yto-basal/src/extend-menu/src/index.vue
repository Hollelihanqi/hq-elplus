<script lang="ts">
import { ref, reactive, defineComponent, h, resolveComponent, onMounted, watch } from "vue";
import { useRouter, onBeforeRouteUpdate } from "vue-router";
// import YtoMenu from 'yto-pc-view-pro/lib/menu/index.js'
// import YtoMenuItem from 'yto-pc-view-pro/lib/menu-item/index.js'
// import YtoSubmenu from 'yto-pc-view-pro/lib/submenu/index.js'
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const onMenu = (item: MenuProps) => {
            console.log(item)
            if (item.name === '应用管理') {
                window.sessionStorage.removeItem('applicationManagement');
            }
...
:deep(.my-yto-menu:not(.el-menu--collapse)) {
    width: 240px;
}
